...
import nl.lance.dribbble.BuildConfig;
...
public class ImageViewNext extends ImageViewEx {
    ...
    /**
     * Sets the loading {@link android.graphics.drawable.Drawable} to be used for every {@link net.frakbot.imageviewex.ImageViewNext}.
     *
    ...
    /**
     * Sets the loading {@link android.graphics.drawable.Drawable} to be used for this {@link net.frakbot.imageviewex.ImageViewNext}.
     *
     * @param loadingDrawable the {@link android.graphics.drawable.Drawable} to display while loading an image.
     */
    ...
    /**
     * Gets the {@link android.graphics.drawable.Drawable} to display while loading an image.
     *
     * @return {@link android.graphics.drawable.Drawable} to display while loading.
     */
    ...
    /**
     * Sets the error {@link android.graphics.drawable.Drawable} to be used for every {@link net.frakbot.imageviewex.ImageViewNext}.
     *
    ...
    /**
     * Sets the error {@link android.graphics.drawable.Drawable} to be used for this {@link net.frakbot.imageviewex.ImageViewNext}.
     *
     * @param errorDrawable the {@link android.graphics.drawable.Drawable} to display after an error getting an image.
     */
    ...
    /**
     * Gets the {@link android.graphics.drawable.Drawable} to display after an error loading an image.
     *
     * @return {@link android.graphics.drawable.Drawable} to display after an error loading an image.
     */
    ...
    /**
     * Sets the content of the {@link net.frakbot.imageviewex.ImageViewNext} with the data to be downloaded
    ...
    /**
     * Returns the current URL set to the {@link net.frakbot.imageviewex.ImageViewNext}.
     * The URL will be returned regardless of the existence of
     * the image or of the caching/downloading progress.
     *
     * @return The URL set for this {@link net.frakbot.imageviewex.ImageViewNext}.
     */
