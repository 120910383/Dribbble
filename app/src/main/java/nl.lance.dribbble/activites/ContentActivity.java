...
import nl.lance.dribbble.animation.ZoomOutPageTransformer;
import nl.lance.dribbble.shots.fragment.Drawer;
import nl.lance.dribbble.shots.fragment.ShotsFragment;
...
public class ContentActivity extends FragmentActivity implements OnPageChangeListener {
  ...
  private class mPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int arg0) {
      String urls[] = {nl.lance.dribbble.network.DribbbleAPI.SHOTS_DEBUTS, nl.lance.dribbble.network.DribbbleAPI.SHOTS_POPULAR, nl.lance.dribbble.network.DribbbleAPI.SHOTS_EVERYONE};
